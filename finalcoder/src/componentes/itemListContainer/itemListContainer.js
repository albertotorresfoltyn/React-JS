        ...
        return(
            ...
            {InfoJson.map((infoDetalle,index )=>{
                ...
                <div>
                    ...
                    <div className="producto">
                        <Item autor={infoDetalle.titulo}  titulo={infoDetalle.titulo} imagen={infoDetalle.imagen} id={infoDetalle.id}/>
                    </div>
            ...
            {InfoJson2.map((infoDetalle,index )=>{
                ...
                <div>
                    <div className="productos">
                    <div className="producto">
                        <Item autor={infoDetalle.autor} titulo={infoDetalle.titulo} imagen={infoDetalle.imagen}id={infoDetalle.id}/>
                    </div>
